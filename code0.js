...
gdjs.LevelCode.GDGameOverDialogObjects1= [];
gdjs.LevelCode.GDGameOverDialogObjects2= [];
gdjs.LevelCode.GDGameOverDialogObjects3= [];
gdjs.LevelCode.GDGameOverDialogObjects4= [];
...
gdjs.LevelCode.GDScreenOrientationCheckerObjects1= [];
gdjs.LevelCode.GDScreenOrientationCheckerObjects2= [];
gdjs.LevelCode.GDScreenOrientationCheckerObjects3= [];
gdjs.LevelCode.GDScreenOrientationCheckerObjects4= [];
...
{for(var i = 0, len = gdjs.LevelCode.GDJoystickObjects2.length ;i < len;++i) {
    gdjs.LevelCode.GDJoystickObjects2[i].hide();
}
}{for(var i = 0, len = gdjs.LevelCode.GDJoystickObjects2.length ;i < len;++i) {
    gdjs.LevelCode.GDJoystickObjects2[i].ActivateControl(false, null);
}
}}
...
};gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDJoystickObjects2Objects = Hashtable.newFrom({"Joystick": gdjs.LevelCode.GDJoystickObjects2});
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__SpriteMultitouchJoystick__HasTouchStartedOnScreenSide.func(runtimeScene, gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDJoystickObjects2Objects, "Left", null);
if (isConditionTrue_0) {
/* Reuse gdjs.LevelCode.GDJoystickObjects2 */
{for(var i = 0, len = gdjs.LevelCode.GDJoystickObjects2.length ;i < len;++i) {
    gdjs.LevelCode.GDJoystickObjects2[i].TeleportAndPress(null);
}
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15652420);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.LevelCode.GDJumpButtonObjects2 */
{for(var i = 0, len = gdjs.LevelCode.GDJumpButtonObjects2.length ;i < len;++i) {
    gdjs.LevelCode.GDJumpButtonObjects2[i].setColor("74;74;74");
}
}}
...
for (var i = 0, k = 0, l = gdjs.LevelCode.GDJumpButtonObjects1.length;i<l;++i) {
    if ( !(gdjs.LevelCode.GDJumpButtonObjects1[i].getBehavior("MultitouchButton").IsPressed(null)) ) {
        isConditionTrue_0 = true;
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15653228);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.LevelCode.GDJumpButtonObjects1 */
{for(var i = 0, len = gdjs.LevelCode.GDJumpButtonObjects1.length ;i < len;++i) {
    gdjs.LevelCode.GDJumpButtonObjects1[i].setColor("255;255;255");
}
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15655124);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15655772);
}
}
if (isConditionTrue_0) {
...
/* Reuse gdjs.LevelCode.GDPlayerObjects2 */
{gdjs.evtsExt__Checkpoints__SaveCheckpoint.func(runtimeScene, gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDPlayerObjects2Objects, (( gdjs.LevelCode.GDCheckpointObjects2.length === 0 ) ? 0 :gdjs.LevelCode.GDCheckpointObjects2[0].getPointX("")), (( gdjs.LevelCode.GDCheckpointObjects2.length === 0 ) ? 0 :gdjs.LevelCode.GDCheckpointObjects2[0].getPointY("")), "Checkpoint", null);
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDCoinParticlesObjects2Objects, (( gdjs.LevelCode.GDCoinObjects2.length === 0 ) ? 0 :gdjs.LevelCode.GDCoinObjects2[0].getCenterXInScene()), (( gdjs.LevelCode.GDCoinObjects2.length === 0 ) ? 0 :gdjs.LevelCode.GDCoinObjects2[0].getCenterYInScene()), "");
...
{gdjs.evtsExt__Player__TriggerDeath.func(runtimeScene, gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDPlayerObjects1Objects, null);
}}
...
{gdjs.evtsExt__Enemy__TriggerFlyDeath.func(runtimeScene, gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDFlyObjects3Objects, "RectangleMovement", "ShakeObject_PositionAngle", null);
}{gdjs.evtsExt__Player__Bounce.func(runtimeScene, gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDPlayerObjects3Objects, "PlatformerObject", null);
...
if (isConditionTrue_0) {
/* Reuse gdjs.LevelCode.GDPlayerObjects2 */
{gdjs.evtsExt__Player__TriggerDeath.func(runtimeScene, gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDPlayerObjects2Objects, null);
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = !(gdjs.evtsExt__Enemy__IsFlyDead.func(runtimeScene, gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDFlyObjects2Objects, null));
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
}{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDMonsterParticlesObjects2Objects, (( gdjs.LevelCode.GDMonsterObjects2.length === 0 ) ? 0 :gdjs.LevelCode.GDMonsterObjects2[0].getCenterXInScene()), (( gdjs.LevelCode.GDMonsterObjects2.length === 0 ) ? 0 :gdjs.LevelCode.GDMonsterObjects2[0].getCenterYInScene()), "");
}{gdjs.evtsExt__Player__Bounce.func(runtimeScene, gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDPlayerObjects2Objects, "PlatformerObject", null);
}{runtimeScene.getScene().getVariables().getFromIndex(0).add(50);
}}
...
for (var i = 0, k = 0, l = gdjs.LevelCode.GDMonsterObjects2.length;i<l;++i) {
    if ( gdjs.LevelCode.GDMonsterObjects2[i].getBehavior("MonsterEnemy").IsOnFire(null) ) {
        isConditionTrue_0 = true;
...
for (var i = 0, k = 0, l = gdjs.LevelCode.GDMonsterObjects1.length;i<l;++i) {
    if ( !(gdjs.LevelCode.GDMonsterObjects1[i].getBehavior("MonsterEnemy").IsOnFire(null)) ) {
        isConditionTrue_0 = true;
...
}{gdjs.evtsExt__Player__AnimateFallingIntoPortal.func(runtimeScene, gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDPlayerObjects2Objects, "Tween", gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDPortalObjects2Objects, null);
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15677820);
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("GameOverDialog"), gdjs.LevelCode.GDGameOverDialogObjects2);
{for(var i = 0, len = gdjs.LevelCode.GDGameOverDialogObjects2.length ;i < len;++i) {
    gdjs.LevelCode.GDGameOverDialogObjects2[i].SetScore(runtimeScene.getScene().getVariables().getFromIndex(0).getAsNumber(), null);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("GameOverDialog"), gdjs.LevelCode.GDGameOverDialogObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.LevelCode.GDGameOverDialogObjects1.length;i<l;++i) {
    if ( gdjs.LevelCode.GDGameOverDialogObjects1[i].IsRetryClicked(null) ) {
        isConditionTrue_0 = true;
        gdjs.LevelCode.GDGameOverDialogObjects1[k] = gdjs.LevelCode.GDGameOverDialogObjects1[i];
        ++k;
    }
}
gdjs.LevelCode.GDGameOverDialogObjects1.length = k;
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15674876);
}
}
if (isConditionTrue_0) {
...
{gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.func(runtimeScene, 0, "Sound", gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDPortalObjects1Objects, gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDPlayerObjects1Objects, 0, 20, 750, null);
}}
...
gdjs.LevelCode.GDGameOverDialogObjects1.length = 0;
gdjs.LevelCode.GDGameOverDialogObjects2.length = 0;
gdjs.LevelCode.GDGameOverDialogObjects3.length = 0;
gdjs.LevelCode.GDGameOverDialogObjects4.length = 0;
...
gdjs.LevelCode.GDScreenOrientationCheckerObjects1.length = 0;
gdjs.LevelCode.GDScreenOrientationCheckerObjects2.length = 0;
gdjs.LevelCode.GDScreenOrientationCheckerObjects3.length = 0;
gdjs.LevelCode.GDScreenOrientationCheckerObjects4.length = 0;
